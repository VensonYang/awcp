...
public class PunManageSystemVO {
	private Long sysId;
	...
	private List<PunManageResourceVO> resources;
	...
	public List<PunManageResourceVO> getResources() {
		return resources;
	}
	
	public void setResources(List<PunManageResourceVO> resources) {
	...
	public String toString() {
		return "PunManageSystemVO [sysId=" + sysId + ", sysAddress=" + sysAddress + ", sysName=" + sysName
				+ ", sysShortName=" + sysShortName + ", sysCreater=" + sysCreater + ", sysCreateTime=" + sysCreateTime
				+ ", sysCreateGroup=" + sysCreateGroup + ", sysStatus=" + sysStatus + ", groupId=" + groupId
				+ ", resources=" + resources + "]";
	}
