...
public class DesUtils {
	...
	public static void main(String[] args) {
		try {
			String test = "@流程已经结束@查看<img src='http://localhost:8080/szcloud/WF/Img/Btn/PrintWorkRpt.gif' ><a href='http://localhost:8080/szcloud/WF/WFRpt.jsp?WorkID=187&FID=0&FK_Flow=001' target='_self' >工作轨迹</a>";
