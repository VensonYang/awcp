...
public class Resume extends EntityOID {
	...
	public Map getEnMap() {
		...
		map.AddTBIntPKOID();
		map.AddTBString(ResumeAttr.FK_Emp, null, "人员", false, false, 0, 200,
				10);
		map.AddTBString(ResumeAttr.NianYue, null, "年月", true, false, 0, 200,
				50);
		map.AddTBString(ResumeAttr.GongZuoDanWei, null, "工作单位", true, false,
				0, 200, 70);
		map.AddTBString(ResumeAttr.ZhengMingRen, "", "证明人", true, false, 0,
				200, 50);
		map.AddTBString(ResumeAttr.BeiZhu, null, "备注", true, false, 0, 200,
				150);
