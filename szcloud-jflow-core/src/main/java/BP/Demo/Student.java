...
public class Student extends EntityNoName {
	...
	public Map getEnMap() {
		...
		map.AddTBString(StudentAttr.Name, null, "名称", true, false, 0,
				200, 70);
		map.AddTBString(StudentAttr.Addr, null, "地址", true, false, 0, 200,
				100, true);
		...
		//外键字段.
		map.AddDDLEntities(StudentAttr.FJ_BanJi, null, "班级", new BanJis(), false);
...
//		map.AddRefMethod(rm);
	...
	public final String DoJiaoNaBanFei(java.math.BigDecimal jine, String note) {
		return "学号:" + this.getNo() + ",姓名:" + this.getName() + ",缴纳了:"
				+ jine +"元,说明:"+ note;
	}
