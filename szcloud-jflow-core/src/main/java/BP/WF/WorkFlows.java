...
import BP.WF.Template.WorkBase.StartWorks;

/** 
 工作流程集合.
 
*/
//public class WorkFlows extends  CollectionBase
public class WorkFlows extends ArrayList<WorkFlow>
{
	...
	*/
	public WorkFlows(Flow flow)
	{
		...
		for (Entity obj : StartWorks.convertEntities(ens))
		{
			StartWork sw = (StartWork) obj ; 
