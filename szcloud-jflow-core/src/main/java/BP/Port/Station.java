...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddDDLSysEnum(StationAttr.StaGrade, 0, "类型", true, true, StationAttr.StaGrade, "@1=高层岗@2=中层岗@3=执行岗");

		map.getAttrsOfOneVSM().Add(new EmpStations(), new Emps(), EmpStationAttr.FK_Station, EmpStationAttr.FK_Emp, DeptAttr.Name, DeptAttr.No, "人员");
