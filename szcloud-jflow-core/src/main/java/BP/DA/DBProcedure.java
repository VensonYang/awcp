...
//		return Integer.parseInt(obj.toString());
	...
	{
		return Float.parseFloat((new Float(DBProcedure.RunSPReturnFloat(spName, conn))).toString());
	}
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	//        return DBProcedure.RunSPReturnDataTable(spName, new Paras(),(Connection)DBAccess.GetAppCenterDBConn );
	//    else
	//        return DBProcedure.RunSPReturnDataTable(spName,new Paras(),(Connection)DBAccess.GetAppCenterDBConn ); 
	//}
	/** 
...
//		{
//			return DBProcedure.RunSPReturnDataTable(spName, paras, (Connection)DBAccess.getGetAppCenterDBConn());
//		}
//		else
//		{
//			return DBProcedure.RunSPReturnDataTable(spName, paras, (Connection)DBAccess.getGetAppCenterDBConn());
//		}
	...
	public static DataTable RunSPReturnDataTable(String spName, Paras paras, Connection conn)
	{
