...
public class DataRow extends LinkedHashMap<String, Object> {
	...
	public Object getValue(int columnIndex) {
		Object obj = this.get(this.columns.get(columnIndex).ColumnName.toLowerCase());
		if(obj == null){
			obj = "";
		}
		return obj;
//		  return this.get(this.columns.get(columnIndex).ColumnName.toLowerCase());
	}
	...
	public Object getValue(DataColumn column) {
		Object obj = this.get(column.ColumnName.toLowerCase());
		if(obj == null){
			obj = "";
		}
		return obj;
