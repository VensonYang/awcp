...
public class SysDocFile extends EntityMyPK {
	...
	public final String getDocText() {
		return this.getD1() + this.getD2() + this.getD3() + this.getD4() + this.getD5() + this.getD6() + this.getD7()
				+ this.getD8() + this.getD9() + this.getD10() + this.getD11() + this.getD12() + this.getD13()
				+ this.getD14() + this.getD15() + this.getD16() + this.getD17() + this.getD18() + this.getD19()
				+ this.getD20();
	}
	...
	public static String GetValHtmlV2(String enName, String pkVal) {
		try {
			return BP.DA.DataType
					.ReadTextFile(BP.Sys.SystemConfig.getPathOfFDB() + enName + File.separator + pkVal + ".fdb");
	...
	public static void SetValV2(String enName, String pkVal, String val) {
		try {
			String dir = BP.Sys.SystemConfig.getPathOfFDB() + enName + File.separator;
			File file = new File(dir);
			if (!file.exists()) {
				file.createNewFile();
			}

			BP.DA.DataType.SaveAsFile(dir + File.separator + pkVal + ".fdb", val);
	...
	public final void UpdateLoadFileOfAccess(String FileName) {
		...
		// string strQuery="UPDATE Sys_FileManager SET FileData=@FileData WHERE
		// OID="+this.OID;
