...
public class ConvertTools {
	...
	public static boolean StreamWriteConvert(String content, String fileName) throws Exception {
		boolean flag = false;
	...
	public static String StreamReaderToStringConvert(String file, String encode) throws IOException {
