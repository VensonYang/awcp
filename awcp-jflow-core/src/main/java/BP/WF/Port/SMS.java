...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	{
		return MsgSta.forValue(this.GetValIntByKey(SMSAttr.EmaiSta));
	}
	public final void setHisEmaiSta(MsgSta value)
	{
		this.SetValByKey(SMSAttr.EmaiSta, value.getValue());
	}
	/** 
	 Email
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddTBInt(SMSAttr.EmaiSta, MsgSta.UnRun.getValue(), "EmaiSta消息状态", true, true);
