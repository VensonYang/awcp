...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	public final String DoApply(int days, String checker, String note1, String note2)
	{
	...
	public final String DoCheck(int days, String checker, String note1, String note2)
	{
		this.setApplyDays(days);
		...
		// 调整当前预警与
		GenerWorkerLists wls = new GenerWorkerLists(this.getWorkID(), this.getNodeId());
		wls.Retrieve(GenerWorkerListAttr.WorkID, this.getWorkID(), GenerWorkerListAttr.FK_Node, this.getNodeId());
