...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	protected boolean beforeInsert()
	{
		...
		if (attr.getUIVisible() && attr.getUIIsReadonly() && this.getEnMap().getIsAutoGenerNo() && this.getNo().length()==0)
		{
			this.setNo(this.getGenerNewNo());
		}

		return super.beforeInsert();
		////if (this.EnMap.IsAutoGenerNo && (this.No == "" || this.No == null || this.No == "自动生成"))
		////{
