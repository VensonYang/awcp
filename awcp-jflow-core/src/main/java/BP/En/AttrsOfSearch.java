...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	/*
	 * warning public final AttrsOfSearch getItem(int index)
	{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	public final void AddHidden(String refKey, String symbol, String val)
	{
		...
		this.add(aos);
		/*
		 * warning AttrOfSearch aos= new AttrOfSearch("K"+this.InnerList.size(), refKey, refKey, symbol, val, 0, true);
	...
	*/
	public final void Add(String lab, String refKey, String defaultSymbol, String defaultvalue, int tbWidth)
	{
		...
		this.add(aos);
		/*
		 * warning AttrOfSearch aos= new AttrOfSearch("K"+this.InnerList.size(), lab, refKey, defaultSymbol, defaultvalue, tbWidth, false);
		this.InnerList.Add(aos);*/
	}
