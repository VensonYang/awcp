...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	public final EntityMultiTree DoCreateSameLevelNode()
	{
		...
		EntityMultiTree en = (EntityMultiTree)((tempVar instanceof EntityMultiTree) ? tempVar : null);
		try {
		...
		en.setIsDir(false);
		try {
			en.setTreeNo(this.GenerNewNoByKey(EntityMultiTreeAttr.TreeNo, EntityMultiTreeAttr.ParentNo, this.getParentNo()));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
		 ...
		 //给实体类赋值.
		en.SetValByKey(this.getRefObjField(), this.GetValStringByKey(this.getRefObjField()));
	...
	*/
	public final EntityMultiTree DoCreateSubNode()
	{
		...
		try {
			en.setTreeNo(this.GenerNewNoByKey(EntityMultiTreeAttr.TreeNo, EntityMultiTreeAttr.ParentNo, this.getNo()));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
	...
	*/
	...
	{
		try {
			this.DoOrderUp(EntityMultiTreeAttr.ParentNo, this.getParentNo(), this.getRefObjField(), this.GetValStringByKey(getRefObjField()), EntityMultiTreeAttr.Idx);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	*/
	...
	{
		try {
			this.DoOrderDown(EntityMultiTreeAttr.ParentNo, this.getParentNo(), this.getRefObjField(), this.GetValStringByKey(getRefObjField()), EntityMultiTreeAttr.Idx);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
