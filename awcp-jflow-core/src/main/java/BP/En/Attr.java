...
public class Attr
{
	...
	*/
	...
	{
		if (this.getMyDataType()==DataType.AppString && !this.getUIIsReadonly())
		{
			return true;
		}
		return false;
	...
	{
		if (getMyDataType() == DataType.AppBoolean || getMyDataType() == DataType.AppDouble || getMyDataType() == DataType.AppFloat || getMyDataType() == DataType.AppInt || getMyDataType() == DataType.AppMoney || getMyDataType() == DataType.AppRate)
		{
			return true;
		}
		else
