...
public class EmpWork extends Entity{
	...
	public Map getEnMap() {
		...
		this.set_enMap(map);
		map.AddTBStringPK(EmpWorkAttr.WorkID, null, "编号", true, false, 0, 50, 50);
		map.AddTBString(EmpWorkAttr.Title, null, "标题", true, false, 0, 50, 200);
		map.AddTBString(EmpWorkAttr.DeptName, null, "部门名称", true, false, 0, 50, 200);
		map.AddTBString(EmpWorkAttr.StarterName, null, "发起人", true, false, 0, 50, 200);
		map.AddTBString(EmpWorkAttr.TodoEmps, null, "人员编号", true, false, 0, 50, 200);
		map.AddTBString(EmpWorkAttr.FlowName, null, "流程名称", true, false, 0, 50, 200);
		map.AddTBString(EmpWorkAttr.SDTOfNode, null, "发起时间", true, false, 0, 50, 200);
