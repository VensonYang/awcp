...
import cn.org.awcp.metadesigner.application.Cache;
import cn.org.awcp.metadesigner.core.domain.EhCacheConfiguration;
...
public class EhCacheBasedCache implements Cache{
     ...
     * @throws Exception 
     */
    public EhCacheBasedCache(String name) throws Exception {
